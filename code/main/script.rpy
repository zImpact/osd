init python:
    ...
    def osd_on_save_callback(slot):
        ...
        persistent.osd_on_save_timeofday[slot] = (
    ...
    def osd_screens_save():
        for screen_name in OSD_SCREENS:
            renpy.display.screen.screens[(OSD_PREFIX + "old_" + screen_name, None)] = renpy.display.screen.screens[(screen_name, None)]
    ...
    def osd_screens_act():
        ...
        for screen_name in OSD_SCREENS:
            renpy.display.screen.screens[(screen_name, None)] = renpy.display.screen.screens[(OSD_PREFIX + screen_name, None)]
        ...
        persistent._file_page = OSD_PREFIX + "FilePage_1"
    ...
    def osd_screens_diact():
        ...
        for screen_name in OSD_SCREENS:
            renpy.display.screen.screens[(screen_name, None)] = renpy.display.screen.screens[(OSD_PREFIX + "old_" + screen_name, None)]
